...
const IMG = "/plants/monstera-albo";

export const monsteraAlbo: PlantListing = {
  identity: {
    id: "monstera-albo",
    slug: "monstera-albo",
    genus: "Monstera",
  ...
  origin: "Cultivated clone in circulation via cuttings, with limited tissue culture lines now appearing",
  family: "Araceae",
  rarity: "Rare",
  priceRange: {
    currency: "USD",
    ...
    note: "Recent tracked plant listings run from about $40 for small low-color stock to $1,950 for premium large-form exact plants. Most ordinary established plants still cluster far below that ceiling, while one-leaf rooted cuttings are generally cheaper.",
  },
  images: {
    hero: `${IMG}/hero.jpg`,
  },
  ...
  tissueCultureInfo: {
    status: "limited",
    note:
      "Tissue culture Monstera Albo now exists, but it is usually not the most desirable way to buy the plant. TC plants can be unstable, grow very slowly while they build stem thickness, and may not hold the same level of variegation buyers expect from established cuttings. Mature rooted cuttings are generally the preferable format when the price gap is reasonable.",
    priceRange: {
      currency: "USD",
      min: 19.99,
      max: 19.99,
  ...
  seoDescription:
    "Monstera Albo price guide with current plant, cutting, and tissue culture pricing from tracked seller history. Mature cuttings are usually the preferred buy over TC starters.",
  quickAnswer:
    ...
    categories: [
      {
        ...
        items: [
          {
            question: "How much does Monstera Albo cost?",
            answer:
          ...
          {
            question: "Why is Monstera Albo more expensive than Thai Constellation?",
            answer:
          ...
          {
            question: "What is a fair price for Monstera Albo?",
            answer:
      ...
      },
      {
        ...
        items: [
          {
            question: "Is Monstera Albo available as tissue culture?",
            answer:
          ...
          {
            question: "Should I buy Monstera Albo tissue culture or a mature cutting?",
            answer:
          ...
          {
            question: "Should I buy Monstera Albo on Facebook Marketplace?",
            answer:
          ...
          {
            question: "Where is the best place to buy Monstera Albo?",
            answer:
      ...
      },
      {
        ...
        items: [
          {
            question: "Is Monstera Albo rare?",
            answer:
          ...
          {
            question: "Is Monstera Albo getting easier to find?",
            answer:
